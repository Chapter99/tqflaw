...
@section('title') แก้ไขข้อมูลวิชา : @parent @endsection
  ...
  <section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">แก้ไขรายวิชา</h3>
                 ...
                 <div class="row">
                     <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('course_id') ? 'is-invalid' :'' }}" id="course_id" name="course_id" placeholder="ป้อนรหัสวิชา" value="{{$course->course_id}}">
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control {{ $errors->has('course_name') ? 'is-invalid' :'' }}" id="course_name" name="course_name" placeholder="ป้อนชื่อวิชาภาษาไทย" value="{{$course->course_name}}">
                            <span class="help-block text-danger"><small>{{ $errors->first('course_name') }}</small></span>
                          </div>
                          <div class="form-group">
                            <label for="name_eng">ชื่อวิชาภาษาอังกฤษ</label>
                            <input type="text" class="form-control {{ $errors->has('name_eng') ? 'is-invalid' :'' }}" id="name_eng" name="name_eng" placeholder="ป้อนชื่อวิชาภาษาอังกฤษ" value="{{$course->name_eng}}">
                            <span class="help-block text-danger"><small>{{ $errors->first('name_eng') }}</small></span>
                          </div>
                          <div class="form-group">
                            <label for="degree">หน่วยกิต</label>
                            <input type="text" class="form-control {{ $errors->has('degree') ? 'is-invalid' :'' }}" id="degree" name="degree" placeholder="ป้อนหน่วยกิต" value="{{$course->degree}}">
