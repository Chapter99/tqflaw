...
@section('title') อนุมัติรายวิชา มคอ.3 และ มคอ.5 @parent @endsection
...
<section class="content-header">
    <div class="container-fluid">
      <div class="mb-2 row">
        <div class="col-sm-6">
          <h1>อนุมัติรายวิชา มคอ.3 และ มคอ.5</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('alltqfs.index') }}">อนุมัติรายวิชา มคอ.3,มคอ.5</a></li>
  ...
  <section class="content">
    ...
    <div class="card">
        ...
        <form role="form" method="post" action="{{ route('alltqfs.update',$alltqf->id) }}" enctype="multipart/form-data">
                  ...
                  <div class="row">
                      <div class="col-md-10">
                         <div class="form-group">
                             ...
                             <input type="text" class="form-control" id="course_id" name="course_id" placeholder="ป้อนรหัสวิชา" value="{{$alltqf->course_id}}">
                          </div>     
